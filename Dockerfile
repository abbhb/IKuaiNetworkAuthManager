...
RUN --mount=type=cache,target=/var/cache/apt,sharing=locked \
  ...
  apt-get update && apt-get install -y gcc ssh default-libmysqlclient-dev pkg-config vim git gettext libjpeg-dev zlib1g-dev wget libldap2-dev libsasl2-dev supervisor
